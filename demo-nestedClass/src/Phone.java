...
public class Phone {
  ...
  private static class Builder {
    // With same attribute of outer clas
    private String number;
    private Color color;
    private double weight;
    ...
    public static void main(String[] args) {
      // chain method: replace different number of args constructor
      Phone phone =Phone.builder().color(Color.GREY).number("1234567").weight(3.7d).build();
